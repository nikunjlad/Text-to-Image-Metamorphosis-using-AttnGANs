...
class condGANTrainer:
    ...
    def prepare_labels(self):
        ...
        # if cfg.PARALLEL:
        #     real_labels = torch.nn.DataParallel(real_labels, device_ids=[2, 3])
        #     fake_labels = torch.nn.DataParallel(fake_labels, device_ids=[2, 3])
        #     match_labels = torch.nn.DataParallel(match_labels, device_ids=[2, 3])
